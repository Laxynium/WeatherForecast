...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        guard let _ = (scene as? UIWindowScene),
            ...
            let citiesController = navController.viewControllers.first as? CitiesController,
            let weatherDetail = splitViewController.viewControllers.last as? WeatherTableController
        else {
            return
        }
        citiesController.cityDelegate = weatherDetail
    }
